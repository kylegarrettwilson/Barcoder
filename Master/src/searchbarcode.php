...
<head>
    ...
    <link rel="stylesheet" href="css/searchbarcode.css">
...
<body>
    ...
    <form action="searchbarcode.php" method="post">

        Barcode : <br><input type="text" id="barcode" name="barcode" value="<?php echo $barcode;?>"><br><br>
